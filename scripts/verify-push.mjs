 ...
 *
 * Phase 0 (scaffold, pre-deploy): audit + hooks + oxlint + format + types + lint + coverage. The
...
const SKIPPED_AT_SCAFFOLD = ['build', 'verify:web-vitals-chunks', 'size:check', 'test:e2e:prod'];
